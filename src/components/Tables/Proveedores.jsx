...
import { removeDataProveedor } from '../../reducer/DataTablesSlice'

// TABLA ABERTURAS, FUNCIONES BORRAR, VER DETALLES, COPIAR. 
const ProveedoresTable = ({ titles, data, setDataEdit }) => {
  ...
  const borrarProveedor = (item) =>{
    setDeleteConfirm(item)
  }

  const confirmDelete = (item) => {
    dispatch(removeDataProveedor(item._id))
